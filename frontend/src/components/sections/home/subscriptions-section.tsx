            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className={`relative h-full rounded-3xl border backdrop-blur-sm overflow-hidden transition-all duration-500 ${plan.popular
                ...
                >
                  {/* Gradient overlay */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-b ${plan.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-700`}
                  />

                  {/* Animated border glow for popular */}
                  {plan.popular && (
                    <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-primary/0 via-primary/20 to-primary/0 opacity-50 animate-pulse" />
                  )}
                  ...
                  <div className="relative z-10 p-8 lg:p-10 flex flex-col h-full">
                    ...
                    <div className="flex items-start justify-between mb-8">
                      <motion.div
                        className={`p-4 rounded-2xl ${plan.iconBg} backdrop-blur-sm border border-white/5`}
                      ...
                      <div className="text-right">
                        <div className={`text-5xl font-black ${plan.iconColor} tracking-tighter`}>
                    ...
                    <ul className="space-y-3 mb-10 flex-grow">
                      {plan.featuresKeys.map((featureKey, fi) => (
                        ...
                        >
                          <div
                            className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${plan.iconBg}`}
                          >
                    ...
                    <Link to="/my-bookings?tab=subscriptions">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        className={`w-full py-4 rounded-2xl font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer ${plan.popular

...
console.log("Applying database migrations manually to avoid ENUM casting errors...");

async function runMigrations() {
  try {
    console.log("1. Altering ticket table to make user_id nullable...");
    await SQL_DRIVER.query(`ALTER TABLE "ticket" ALTER COLUMN "user_id" DROP NOT NULL;`);
    ...
    await SQL_DRIVER.query(`ALTER TABLE "ticket" ADD COLUMN IF NOT EXISTS "customer_name" TEXT;`);
    
    console.log("3. Adding customer_phone column to ticket table...");
    await SQL_DRIVER.query(`ALTER TABLE "ticket" ADD COLUMN IF NOT EXISTS "customer_phone" TEXT;`);
